...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| [SparseOcc (Baseline)](projects/configs/baseline/sparseocc_nusc_256.py) | nuScenes | ResNet50 | 13.2 | ... | [Link](log/training/nusc_origin_tr.log) | [Link](log/inference/nusc_origin_in.md) |
| [SpotOcc (Ours)](projects/configs/spotocc/spotocc_nusc_256.py) | nuScenes | ResNet50 | 13.7 | ... | [Link](log/training/nusc_spot_tr.log) | [Link](log/inference/nusc_spot_in.md) |
| [SparseOcc (Baseline)](projects/configs/baseline/sparseocc_kitti.py) | SemanticKITTI | EfficientNetB7 | 12.2 | ... | [Link](log/training/kitti_origin_tr.log) | [Link](log/inference/kitti_origin_in.md) |
| [SpotOcc (Ours)](projects/configs/spotocc/spotocc_kitti.py) | SemanticKITTI | EfficientNetB7 | 13.3 | ... | [Link](log/training/kitti_spot_tr.log) | [Link](log/inference/kitti_spot_in.md) |

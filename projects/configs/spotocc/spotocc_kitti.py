...
work_dir = 'work_dirs/spotocc_kitti'
sync_bn = True
plugin = True
...
model = dict(
    ...
    pts_bbox_head=dict(
        type='SparseProtoMask2FormerOccHead',
        ...
        dn_cfg=dict(
            scalar=1,
            noise_scale=0.01,
            dn_label_noise_ratio=0.01
        ),
        # using stand-alone positional encoding
        positional_encoding=dict(
            type='SinePositionalEncoding3D', num_feats=mask2former_pos_channel, normalize=True),
        # switch transformer decoder to PEM style
        transformer_decoder=dict(
            type='DetrTransformerDecoder',
            return_intermediate=True,
            num_layers=9,
            transformerlayers=dict(
                type='SparseProtoTransformerDecoderLayer_0',
                spot_ca_cfg=dict(

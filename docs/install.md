...
SpotOcc is developed based on the official OccFormer, OpenOccupancy and SparseOcc codebase and the installation follows similar steps.

**1. Create a conda virtual environment and activate**

```shell
conda create -n spotocc python=3.8 -y
conda activate spotocc
```
